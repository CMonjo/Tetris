...
int set_key_drop(tetris_t *t, char **av, int i)
{
	...
	else if (my_strcmp(av[i], stgs[5].short_name) == 0 &&
	av[i + 1] != NULL) {
...
int set_key_turn(tetris_t *t, char **av, int i)
{
	...
	else if (my_strcmp(av[i], stgs[4].short_name) == 0 &&
	av[i + 1] != NULL) {
...
int set_key_right(tetris_t *t, char **av, int i)
{
	...
	else if (my_strcmp(av[i], stgs[3].short_name) == 0 &&
	av[i + 1] != NULL) {
...
int set_key_left(tetris_t *t, char **av, int i)
{
	...
	else if (my_strcmp(av[i], stgs[2].short_name) == 0 &&
	av[i + 1] != NULL) {
